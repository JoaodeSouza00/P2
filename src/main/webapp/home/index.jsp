...
<html><!--iniciando a estrutura do navegador-->
    ...
    <head><!--iniciando a estrutura do cabeçario-->
        ...
        <title>Exemplo de View</title><!--definindo o titudo da pagina -->

        <link href="css/default.css" rel="stylesheet" /><!--dizendo que a estilização em css sera feita na pagina css/default.css -->

    </head><!--finalizando a estrutura do cabeçario-->

    <body><!--iniciando a estrutura do corpo-->

        <h1>Lista de Livros</h1><!--definindo um titulo da pagina-->
